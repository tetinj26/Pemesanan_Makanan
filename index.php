    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Teti Nurjanah © 2023 Online Food Order system | <a href="https://www.youtube.com/c/Nowdemy/" target="_blank">WiHOUSE</a></div></div>
        </footer>
